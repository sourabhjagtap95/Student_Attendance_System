...
<body>
<div class="container">
	<br><p><strong>Attendance</strong></p><br>
<form class="form-inline" role="form" name="seeattendance" method="POST" action="see_attendance.php">
<div class="container ">
<fieldset>
	<legend>
            <strong>Select Division, Subject and Month:</strong>
    </legend>
