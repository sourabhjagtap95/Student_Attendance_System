...
if( $captcha_code == $user_code) {
    ...
    if ($noofrows == 0) {
        ...
        /*Insert data into student record*/
        $query1 = "insert into student_record(username,firstname,lastname,dob,gender,classyear,division,batch,rollno,email,mobile,address) values ('$username','$firstname','$lastname','$birthdate-$birthmonth-$birthyear','$gender','$classyear','$division','$batch','$rollno','$email','$mobile','$address')";
        mysql_query($query1) or die(mysql_errno($conn));
