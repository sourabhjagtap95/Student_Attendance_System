...
{  
    ...
    {
        alert("First Name must be a valid name.First letter should be capital.");  
        firstname.focus();  
        return false;
    }
}   
...
{  
    ...
    {
        alert("Last Name must be a valid name.First letter should be capital.");  
        lastname.focus();  
        return false;
    }
}
...
<body onload="document.teacher_registration.firstname.focus();">
    ...
    <div class="container">
    <br><br><p><strong>SIGN UP FORM FOR TEACHERS</strong></p><br>
        <div class="row">
      		<div class="col-md-3"></div>
            <div class="col-md-6">
            <div class="well">

			<form name="teacher_registration" action="teacher_record.php" method="post" onsubmit="return formValidation();">
			<div class="form-element multi-field name" id="name">
                    ...
                    <fieldset>
                        ...
                        <label>
                            <input type="text" name="uid" id="text-fields" class="form-control" placeholder="Uid" required>
                        </label>
                    </fieldset>
                                     <fieldset>
                        <legend>
    ...
    <div class="col-md-3" style="background-color: #E6E6E6"></div>
    </div>
    </div>
 </form>   
